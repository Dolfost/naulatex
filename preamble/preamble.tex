...
\titlespacing*{\subsubsection}{0mm}{5mm}{1mm}
...
\setminted{numbers=right, linenos=true, autogobble, breaklines, bgcolor=CodeBackground, frame=leftline, framerule=0.35pt, framesep=2mm, numbersep=1mm, highlightcolor=LimeGreen, curlyquotes=true, mathescape, stepnumber=1, fontsize=\footnotesize, xleftmargin=0cm}

\usepackage{enumitem}
\setlist{noitemsep, itemsep=0.5mm, topsep=1mm, labelsep=2mm}%, nolistsep}
\setlist[itemize,1]{label=\textbullet, font=\ttfamily, align=right}
\setlist[itemize, 2]{label=\textopenbullet}
\setlist[itemize, 3]{label=\(\vartriangleleft\)}
\setlist[enumerate, 1]{label=\textcircled{\scriptsize\arabic*}, font=\sffamily, align=right, start=1}
\setlist[enumerate, 2]{label=\textcircled{\scriptsize\Alph*}}
\setlist[description, 1]{itemsep=1mm, style=nextline, font=\mdseries, align=left}
