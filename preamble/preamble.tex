...
\setminted{numbers=right, linenos=true, autogobble, breaklines, bgcolor=CodeBackground, frame=leftline, framerule=0.35pt, framesep=2mm, numbersep=1mm, highlightcolor=LimeGreen, curlyquotes=true, mathescape, stepnumber=1, fontsize=\footnotesize}
...
\setlist[description, 1]{style=nextline, font=\mdseries, align=left}
