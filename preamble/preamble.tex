...
\usepackage{wrapfig}
\usepackage{caption}
\captionsetup{font=sf, labelfont=sf, margin=1cm, skip=2.5mm, labelsep=period, figureposition=below,
			  tableposition=above}
\DeclareCaptionFormat{tableCaption}{{\hfill#1#2\\#3}}
\captionsetup[table]{format=tableCaption, name={Таблиця}, labelsep=none}
\usepackage{titlesec}
